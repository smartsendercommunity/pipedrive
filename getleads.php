...
if ($input["leadId"] != NULL) {
    ...
    $getLead = json_decode(send_request("https://api.pipedrive.com/v1/leads/".$input["leadId"]."?api_token=".$pdKey), true);
    ...
    $getLead = json_decode(send_request("https://api.pipedrive.com/v1/leads?person_id=".$contactId."&api_token=".$pdKey), true);
    if ($getLead["success"] === false) {
        sleep(1);
        $getLead = json_decode(send_request("https://api.pipedrive.com/v1/leads?person_id=".$contactId."&api_token=".$pdKey), true);
    }
